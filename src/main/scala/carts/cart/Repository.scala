...
object Repository {
  ...
  private class PostgresRepository(ctx: PostgresJdbcContext[SnakeCase]) extends Repository {
    ...
    private case class Carts(id: Long, cartId: Long, store: Long, isMovable: Boolean, customer: Option[String])

    private val idPlaceholder: Long = 0 // id is automatically generated by Postgresql
